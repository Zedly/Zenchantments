...
public class CompatibilityAdapter {
    ...
    //region Enums
    //region Colors
    public final EnumStorage<Material> BEDS = new EnumStorage<>(new Material[]{BLACK_BED, BLUE_BED, BROWN_BED,
    ...
    public final EnumStorage<Material> WOOL = new EnumStorage<>(new Material[]{BLACK_WOOL, BLUE_WOOL, BROWN_WOOL,
    ...
    public final EnumStorage<Material> SHULKER_BOXES = new EnumStorage<>(new Material[]{BLACK_SHULKER_BOX,
    ...
    public final EnumStorage<Material> CONCRETE_POWDERS = new EnumStorage<>(new Material[]{BLACK_CONCRETE_POWDER,
    ...
    public final EnumStorage<Material> CONCRETES = new EnumStorage<>(new Material[]{BLACK_CONCRETE, BLUE_CONCRETE,
    ...
    public final EnumStorage<Material> GLAZED_TERRACOTTAS = new EnumStorage<>(new Material[]{
    ...
    public final EnumStorage<Material> TERRACOTTAS = new EnumStorage<>(new Material[]{TERRACOTTA, BLACK_TERRACOTTA,
    ...
    public final EnumStorage<Material> CARPETS = new EnumStorage<>(new Material[]{BLACK_CARPET,
    ...
    public final EnumStorage<Material> STAINED_GLASSES = new EnumStorage<>(new Material[]{BLACK_STAINED_GLASS,
    ...
    public final EnumStorage<Material> STAINED_GLASS_PANES = new EnumStorage<>(new Material[]{
    ...
    public final EnumStorage<Material> BANNERS = new EnumStorage<>(new Material[]{BLACK_BANNER,
    ...
    public final EnumStorage<Material> WALL_BANNERS = new EnumStorage<>(new Material[]{BLACK_WALL_BANNER,
    ...
    public final EnumStorage<Material> DYES = new EnumStorage<>(new Material[]{INK_SAC,
	...
	public final EnumStorage<Material> TERRAFORMER_MATERIALS = new EnumStorage<>(new Material[]{STONE, GRASS,
    ...
    public final EnumStorage<Material> LUMBER_WHITELIST = new EnumStorage<>(new Material[]{
        ...
        MOSSY_COBBLESTONE, CLAY, BROWN_MUSHROOM, RED_MUSHROOM, MYCELIUM, TORCH, SUGAR_CANE},
    ...
    public EnumStorage<Material> getTerraformerMaterials() {
