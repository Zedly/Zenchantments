...
public class EnchantPlayer {
    ...
    private final Map<Integer, Integer> enchantCooldown;   // Enchantment names mapped to their remaining cooldown                // Collection of disabled enchantments for the player
    ...
    public void disableAll() {
        for (CustomEnchantment enchant : Config.get(player.getWorld()).getEnchants().values()) {
            player.setMetadata("ze." + enchant.enchantmentID, new FixedMetadataValue(Storage.zenchantments, true));
        }
    }
    ...
    public void enableAll() {
        for (CustomEnchantment enchant : Config.get(player.getWorld()).getEnchants().values()) {
            player.setMetadata("ze." + enchant.enchantmentID, new FixedMetadataValue(Storage.zenchantments, false));
        }
    }
