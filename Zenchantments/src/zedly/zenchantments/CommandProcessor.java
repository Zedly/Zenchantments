...
public class CommandProcessor {
    ...
    private static boolean give(EnchantPlayer player, String[] args, Config config) {
        ...
        if (args.length >= 4) {
            ...
            StringBuilder msgBldr = new StringBuilder(Storage.logo + "Gave " + ChatColor.DARK_AQUA + recipient.getName()
            ...
            player.sendMessage(Storage.logo + ChatColor.DARK_AQUA + "Usage: " + ChatColor.AQUA
    ...
    private static boolean disable(EnchantPlayer player, Config config, String[] args) {
        ...
        if (args.length > 1) {
	        ...
	        player.sendMessage(Storage.logo +  ChatColor.DARK_AQUA + "Usage: " + ChatColor.AQUA + "/ench disable <enchantment/all>");
        }
        return true;
    }
    ...
    private static boolean enable(EnchantPlayer player, Config config, String[] args) {
        ...
        if (args.length > 1) {
	        ...
	        player.sendMessage(Storage.logo + ChatColor.DARK_AQUA + "Usage: " + ChatColor.AQUA + "/ench enable <enchantment/all>");
        }
        return true;
    }
