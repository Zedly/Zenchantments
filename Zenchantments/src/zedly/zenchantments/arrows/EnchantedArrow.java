...
public class EnchantedArrow {
    ...
    /**
     * Creates a new EnchantedArrow from the given arrow with the specified level and power.
     *
    ...
    /**
     * Creates a new EnchantedArrow from the given arrow with the specified level.
     *
     * @param arrow Arrow entity from which to make the EnchantedArrow.
     * @param level Level of enchantment on arrow.
     */
