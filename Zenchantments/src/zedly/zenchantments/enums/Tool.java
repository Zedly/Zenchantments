...
public enum Tool {
    ...
    ALL("All", new Material[]{WOOD_AXE, STONE_AXE, GOLD_AXE, IRON_AXE, DIAMOND_AXE, WOOD_SPADE, STONE_SPADE, GOLD_SPADE,
        IRON_SPADE, DIAMOND_SPADE, WOOD_SWORD, STONE_SWORD, GOLD_SWORD, IRON_SWORD, DIAMOND_SWORD, WOOD_PICKAXE,
        STONE_PICKAXE, GOLD_PICKAXE, IRON_PICKAXE, DIAMOND_PICKAXE, FISHING_ROD, SHEARS, Material.BOW, FLINT_AND_STEEL,
        WOOD_HOE, STONE_HOE, GOLD_HOE, IRON_HOE, DIAMOND_HOE, DIAMOND_HELMET, IRON_HELMET, GOLD_HELMET, CHAINMAIL_HELMET,
        LEATHER_HELMET, DIAMOND_CHESTPLATE, IRON_CHESTPLATE, GOLD_CHESTPLATE, CHAINMAIL_CHESTPLATE, LEATHER_CHESTPLATE,
        ELYTRA, DIAMOND_LEGGINGS, IRON_LEGGINGS, GOLD_LEGGINGS, CHAINMAIL_LEGGINGS, LEATHER_LEGGINGS, DIAMOND_BOOTS,
        IRON_BOOTS, GOLD_BOOTS, CHAINMAIL_BOOTS, LEATHER_BOOTS, ELYTRA}, false);
