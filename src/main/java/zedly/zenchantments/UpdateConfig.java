...
public class UpdateConfig {
	...
	private static void oneFourZero(YamlConfiguration config) {
		List<Map<String, LinkedHashMap<String, Object>>> list =
			(List<Map<String, LinkedHashMap<String, Object>>>) config.get("enchantments");
		...
		List<Map<String, Map<String, Object>>> list2 =
			(List<Map<String, Map<String, Object>>>) config.get("enchantments");
