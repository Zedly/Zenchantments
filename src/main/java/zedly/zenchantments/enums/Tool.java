...
public enum Tool {
    ...
    BOW("Bow", new Material[]{Material.BOW, CROSSBOW}, true),
    ...
    ALL("All", new Material[]{WOODEN_AXE, STONE_AXE, GOLDEN_AXE, IRON_AXE, DIAMOND_AXE, NETHERITE_AXE,
        ...
        FISHING_ROD, SHEARS, Material.BOW, CROSSBOW, FLINT_AND_STEEL, ELYTRA,
        ...
        NETHERITE_BOOTS, DIAMOND_BOOTS, IRON_BOOTS, GOLDEN_BOOTS, CHAINMAIL_BOOTS, LEATHER_BOOTS}, false);
